...
const Color kFigmaAppBarBg = Color(
  0xFFEBEADB,
); // Barra superior crema ligeramente más oscura
const Color kFigmaInputBg = Color(0xFFFFFFFF); // Fondo blanco de los inputs
const Color kFigmaInputBorder = Color(
  0xFFCCCCCC,
); // Borde gris claro/fino de Figma
const Color kFigmaBtnPrimary = Color(0xFFD6D6D6); // Botón gris de Figma
const Color kFigmaTextDark = Color(
  0xFF111111,
); // Texto casi negro para títulos y botones
